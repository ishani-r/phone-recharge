         ...
         <div class="col-md-8">
            <div class="card">
               <div class="card-header card-header-primary">
                  <h4 class="card-title">{{ trans('Add User')}}</h4>
                  <!-- <p class="card-category">{{ trans('Complete your profile')}}</p> -->
               </div>
               <div class="card-body">
                  <!-- <form> -->
                  {!! Form::open(['route'=> array('admin.dashboard.store'), 'id' => 'user_form', 'enctype' => 'multipart/form-data']) !!}
                  @csrf
                  <!-- -------------------------------------- Name ------------------------------------ -->
                  <div class="row">
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label class="bmd-label-floating">{{ Form::label('mobile',trans('Mobile'))}}</label>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label class="bmd-label-floating">{{ Form::label('dob',trans('Birth Date'))}}</label>
